...
export const createMessagingEnvelope = (correlationId = randomUUID(), publishedAt = null, filesInBatch = 1) => ({
  correlationId,
  publishedAt,
  filesInBatch
})
...
export const createFormattedDocument = (metadata, fileUpload, options = {}) => {
  ...
  return {
    ...
    messaging: createMessagingEnvelope(correlationId, publishedAt, filesInBatch)
  }
}
